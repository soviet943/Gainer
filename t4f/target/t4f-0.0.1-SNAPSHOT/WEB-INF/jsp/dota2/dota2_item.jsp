		...
		<div class="detail-left">
			<div class="sale-item">
				<div class="sale-item-bg">
					<img id="item_img" src="http://120.78.164.143:80/images/dota2_item/${item.data.img }.png" style="max-width: 100%" height="208">
				</div>
				<div class="sale-item-info">
					...
					<div class="attr_hero">
						使用英雄：
						<img class="hero-icon" src="http://120.78.164.143:80/images/dota2_hero/${item.data.hero }.png">
						<a href="">${item.data.hero }</a>
					</div>
						...
						<li class="pull-right" style="width: 112px;">
							...
							<c:choose>
		                        ...
		                        <c:when test="${user != null}">
		                        	...
		                        	<c:if test="${need <= 0 }">
		                        		<button class="btn btn-orange" onclick="addToCart('dota2_${item.data.id }')">加入购物车</button>
		                        	</c:if>
		                        </c:when>
		                    </c:choose>
			            </li>
